...
para que tengan una sección Java.

## Orígenes

Se inicia en [mi curso en línea](http://ajlopez.net/cursos/Course.php?Id=1) y en 
mi experiencia ganada en escribir [Aprendiendo Ruby](https://github.com/ajlopez/AprendiendoRuby).
Quiero aprovechar mi cuenta de GitHub para transaladar y completar el curso inicial.
...
- Enviando sugerencias y correcciones. Usemos los [issues de GitHub](https://github.com/ajlopez/AprendiendoJava/issues)
